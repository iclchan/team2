...
public class Instrument0005Controller {
	...
	public static void sell(String price, String qty){
		OrderController.postMarketOrder("0005", "sell", price, qty);
	}
	
	public static void sellLimit(String price, String qty){
		OrderController.postLimitOrder("0005", "sell", price, qty);
	}
	
	//returns actual price that I bought
	public static void buyLimit(String price, String qty){
		OrderController.postLimitOrder("0005", "buy", price, qty);
	}
	...
	public static HashMap<String, Object> buy(String price, String qty){
		...
		HashMap<String, Object> resultMap = OrderController.postMarketOrder("0005", "buy", price, qty);
		return resultMap;
	}
}

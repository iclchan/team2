...
import entity.Instrument0388;

public class Instrument0388Controller {
	
	
	public static void sell(String price, String qty){
		OrderController.postMarketOrder("0388", "sell", price, qty);
	}
	
	public static void sellLimit(String price, String qty){
		OrderController.postLimitOrder("0388", "sell", price, qty);
	}
	
	//returns actual price that I bought
	public static void buyLimit(String price, String qty){
		OrderController.postLimitOrder("0388", "buy", price, qty);
	}
	...
	public static HashMap<String, Object> buy(String price, String qty){
		...
		HashMap<String, Object> resultMap = OrderController.postMarketOrder("0388", "buy", price, qty);
		return resultMap;
	}
}

...
public class Instrument3988Controller {
	...
	public static void sellLimit(String price, String qty){
		OrderController.postLimitOrder("3988", "sell", price, qty);
	}
	
	//returns actual price that I bought
	public static void buyLimit(String price, String qty){
		OrderController.postLimitOrder("3988", "buy", price, qty);
	}
	...
	public static HashMap<String, Object> buy(String price, String qty){
		...
		HashMap<String, Object> resultMap = OrderController.postMarketOrder("3988", "buy", price, qty);
		return resultMap;
	}
}
